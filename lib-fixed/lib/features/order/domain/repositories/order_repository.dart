...
abstract class OrderRepository {
  ...
  /// Konfirmasi ke backend bahwa pembayaran via CashLess sudah sukses.
  /// Wajib dipanggil setelah menerima callback sukses, karena backend
  /// tidak tahu status pembayaran tanpa dikonfirmasi secara eksplisit.
  Future<OrderModel> confirmPayment(int orderId);
}
